...
from app.pydotorg.mixins import GroupRequiredMixin, LoginRequiredMixin

from app.jobs.forms import JobForm, JobReviewCommentForm
from app.jobs.models import Job, JobType, JobCategory, JobReviewComment
...
class JobListType(JobTypeMenu, JobMixin, ListView):
    paginate_by = 25
    template_name = 'job_type_list.html'
...
class JobListLocation(JobLocationMenu, JobMixin, ListView):
    paginate_by = 25
    template_name = 'job_location_list.html'
...
class JobTelecommute(JobLocationMenu, JobList):
    ...
    template_name = 'job_telecommute_list.html'
