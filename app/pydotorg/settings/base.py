...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                'app.pydotorg.context_processors.site_info',
                'app.pydotorg.context_processors.url_name',
                'app.pydotorg.context_processors.get_host_with_scheme',
                'app.pydotorg.context_processors.blog_url',
                'app.pydotorg.context_processors.user_nav_bar_links',
            ],
        },
    },
]
...
ROOT_URLCONF = 'app.pydotorg.urls'
...
MIDDLEWARE = [
    ...
    'app.pydotorg.middleware.AdminNoCaching',
    'app.pydotorg.middleware.GlobalSurrogateKey',
...
WSGI_APPLICATION = 'app.pydotorg.wsgi.application'
