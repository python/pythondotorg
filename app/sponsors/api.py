...
from app.sponsors.models import BenefitFeature, LogoPlacement, Sponsorship, GenericAsset
from app.sponsors.serializers import LogoPlacementSerializer, FilterLogoPlacementsSerializer, FilterAssetsSerializer, \
    AssetSerializer
