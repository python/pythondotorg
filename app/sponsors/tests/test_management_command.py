...
from app.sponsors.models import ProvidedTextAssetConfiguration, ProvidedTextAsset
from app.sponsors.models.enums import AssetsRelatedTo

from app.sponsors.management.commands.create_pycon_vouchers_for_sponsors import (
