...
from app.sponsors.models import Sponsorship, RequiredTextAssetConfiguration, SponsorBenefit
from app.sponsors.models.enums import AssetsRelatedTo
from app.sponsors.tests.utils import get_static_image_file_as_upload
