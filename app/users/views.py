...
from app.pydotorg.mixins import LoginRequiredMixin
from app.sponsors.forms import SponsorUpdateForm, SponsorRequiredAssetsForm
from app.sponsors.models import Sponsor, BenefitFeature

from app.users.forms import (
    UserProfileForm, MembershipForm, MembershipUpdateForm,
)
from app.users.models import Membership
from app.sponsors.models import Sponsorship
...
class MembershipThanks(TemplateView):
    template_name = 'membership_thanks.html'


class MembershipVoteAffirm(TemplateView):
    template_name = 'membership_vote_affirm.html'
...
class MembershipVoteAffirmDone(TemplateView):
    template_name = 'membership_vote_affirm_done.html'
...
class UserNominationsView(LoginRequiredMixin, TemplateView):
    model = User
    template_name = 'nominations_view.html'
...
class UserSponsorshipsDashboard(ListView):
    ...
    template_name = 'list_user_sponsorships.html'
...
class UpdateSponsorInfoView(UpdateView):
    object_name = "sponsor"
    template_name = 'new_sponsorship_application_form.html'
...
class UpdateSponsorshipAssetsView(UpdateView):
    ...
    template_name = 'sponsorship_assets_update.html'
...
class ProvidedSponsorshipAssetsView(DetailView):
    object_name = "sponsorship"
    template_name = 'sponsorship_assets_view.html'
