    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "calendar",
                    models.ForeignKey(
                        null=True, to="events.Calendar", related_name="categories", blank=True, on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "calendar",
                    models.ForeignKey(
                        null=True, to="events.Calendar", related_name="locations", blank=True, on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "event",
                    models.OneToOneField(to="events.Event", related_name="occurring_rule", on_delete=models.CASCADE),
                ),
            ],
            options={},
            bases=(apps.events.models.RuleMixin, models.Model),
        ),
        migrations.CreateModel(
            name="RecurringRule",
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        verbose_name=((0, "year(s)"), (1, "month(s)"), (2, "week(s)"), (3, "day(s)")), default=2
                    ),
                ),
                (
                    "event",
                    models.ForeignKey(to="events.Event", related_name="recurring_rules", on_delete=models.CASCADE),
                ),
            ],
            options={},
            bases=(apps.events.models.RuleMixin, models.Model),
        ...
        migrations.AddField(
            ...
            name="venue",
            field=models.ForeignKey(
                null=True, to="events.EventLocation", related_name="events", blank=True, on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AddField(
