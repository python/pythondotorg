        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "label",
                    models.CharField(
                        help_text="What's the title used to display the input to the sponsor?", max_length=256
                    ),
                ),
                (
                    "help_text",
            ...
            bases=(apps.sponsors.models.benefits.RequiredAssetMixin, "sponsors.benefitfeature", models.Model),
        ),
        migrations.CreateModel(
