...
from apps.sponsors.models import ImgAsset, Sponsor, Sponsorship, TextAsset
...
class LogoPlacementeAPIListTests(APITestCase):
    ...
    def setUp(self):
        ...
        sponsorships = baker.make_recipe(
            "apps.sponsors.tests.finalized_sponsorship", sponsor=iter(self.sponsors), _quantity=3
        )
        self.sp1, self.sp2, self.sp3 = sponsorships
        baker.make_recipe("apps.sponsors.tests.logo_at_download_feature", sponsor_benefit__sponsorship=self.sp1)
        baker.make_recipe("apps.sponsors.tests.logo_at_sponsors_feature", sponsor_benefit__sponsorship=self.sp1)
        baker.make_recipe("apps.sponsors.tests.logo_at_sponsors_feature", sponsor_benefit__sponsorship=self.sp2)
        baker.make_recipe(
