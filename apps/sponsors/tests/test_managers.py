...
class SponsorshipQuerySetTests(TestCase):
    ...
    def test_filter_sponsorship_with_logo_placement_benefits(self):
        sponsorship_with_download_logo = baker.make_recipe("apps.sponsors.tests.finalized_sponsorship")
        sponsorship_with_sponsors_logo = baker.make_recipe("apps.sponsors.tests.finalized_sponsorship")
        simple_sponsorship = baker.make_recipe("apps.sponsors.tests.finalized_sponsorship")

        download_logo_benefit = baker.make(SponsorBenefit, sponsorship=sponsorship_with_download_logo)
        baker.make_recipe("apps.sponsors.tests.logo_at_download_feature", sponsor_benefit=download_logo_benefit)
        sponsors_logo_benefit = baker.make(SponsorBenefit, sponsorship=sponsorship_with_sponsors_logo)
        baker.make_recipe("apps.sponsors.tests.logo_at_sponsors_feature", sponsor_benefit=sponsors_logo_benefit)
    ...
    def test_filter_sponsorship_by_benefit_feature_type(self):
        sponsorship_feature_1 = baker.make_recipe("apps.sponsors.tests.finalized_sponsorship")
        sponsorship_feature_2 = baker.make_recipe("apps.sponsors.tests.finalized_sponsorship")
