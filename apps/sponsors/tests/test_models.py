...
from apps.sponsors.models.enums import AssetsRelatedTo, LogoPlacementChoices, PublisherChoices
...
class SponsorshipModelTests(TestCase):
    ...
    def test_rollback_approved_sponsorship_with_contract_should_delete_it(self):
        ...
        sponsorship.save()
        baker.make_recipe("apps.sponsors.tests.empty_contract", sponsorship=sponsorship)
    ...
    def test_can_not_rollback_sponsorship_to_edit_if_contract_was_sent(self):
        ...
        sponsorship.status = Sponsorship.APPROVED
        sponsorship.save()
        baker.make_recipe("apps.sponsors.tests.awaiting_signature_contract", sponsorship=sponsorship)
...
class ContractModelTests(TestCase):
    ...
    def test_auto_increment_draft_revision_on_save(self):
        contract = baker.make_recipe("apps.sponsors.tests.empty_contract")
    ...
    def test_does_not_auto_increment_draft_revision_on_save_if_other_states(self):
        contract = baker.make_recipe("apps.sponsors.tests.empty_contract", revision=10)
...
- PSF - {b3.name} [^3]"""
    ...
    def test_raise_invalid_status_when_trying_to_execute_contract_if_not_awaiting_signature(self):
        contract = baker.make_recipe("apps.sponsors.tests.empty_contract", status=Contract.OUTDATED)
    ...
    def test_raise_invalid_status_when_trying_to_nullify_contract_if_not_awaiting_signature(self):
        contract = baker.make_recipe("apps.sponsors.tests.empty_contract", status=Contract.DRAFT)
...
class SponsorBenefitModelTests(TestCase):
    ...
    def test_sponsor_benefit_name_for_display(self):
        ...
        baker.make(TieredBenefit, sponsor_benefit=sponsor_benefit, quantity=10)
