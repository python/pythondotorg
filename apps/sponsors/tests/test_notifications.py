...
from apps.sponsors.models import Contract, RequiredTextAssetConfiguration, SponsorBenefit, Sponsorship
...
class SponsorshipApprovalLoggerTests(TestCase):
    def setUp(self):
        ...
        self.contract = baker.make_recipe("apps.sponsors.tests.empty_contract", sponsorship=self.sponsorship)
