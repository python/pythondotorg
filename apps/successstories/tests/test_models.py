...
from apps.successstories.factories import StoryCategoryFactory, StoryFactory
from apps.successstories.models import Story
...
class StoryModelTests(TestCase):
    ...
    def test_get_admin_url(self):
        self.assertEqual(self.story1.get_admin_url(), f"/admin/successstories/story/{self.story1.pk}/change/")
