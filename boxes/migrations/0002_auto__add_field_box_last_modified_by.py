...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Box.last_modified_by'
        db.add_column('boxes_box', 'last_modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, related_name='boxes_box_modified', blank=True, to=orm['users.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Box.last_modified_by'
        db.delete_column('boxes_box', 'last_modified_by_id')
    ...
    models = {
        ...
        'boxes.box': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'boxes_box_creator'", 'blank': 'True', 'to': "orm['users.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '100'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'boxes_box_modified'", 'blank': 'True', 'to': "orm['users.User']"}),
