"""Models for homepage code samples."""
...
class CodeSample(ContentManageable):
    """A code snippet and description displayed on the homepage."""
    ...
    class Meta:
        """Meta configuration for CodeSample."""

        verbose_name = "sample"
        verbose_name_plural = "samples"

    def __str__(self):
        """Return a truncated plain-text preview of the copy field."""
