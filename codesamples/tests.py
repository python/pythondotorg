...
class CodeSampleModelTests(TestCase):
    def setUp(self):
        self.sample2 = CodeSample.objects.create(code="Code One", copy="Copy One", is_published=True)

        self.sample2 = CodeSample.objects.create(code="Code Two", copy="Copy Two", is_published=False)
