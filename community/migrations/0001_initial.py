    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "media_type",
                    models.IntegerField(choices=[(1, "text"), (2, "photo"), (3, "video"), (4, "link")], default=1),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                editable=False, null=True, to="community.Post", related_name="related_photo", on_delete=models.CASCADE
            ),
        ...
        migrations.AddField(
            ...
            name="post",
            field=models.ForeignKey(
                editable=False, null=True, to="community.Post", related_name="related_link", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
    ]
