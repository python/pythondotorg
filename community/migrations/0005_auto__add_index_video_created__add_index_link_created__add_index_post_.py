...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('community_video', ['created'])

        # Adding index on 'Link', fields ['created']
        db.create_index('community_link', ['created'])

        # Adding index on 'Post', fields ['created']
        db.create_index('community_post', ['created'])

        # Adding index on 'Photo', fields ['created']
        db.create_index('community_photo', ['created'])


    def backwards(self, orm):
        # Removing index on 'Photo', fields ['created']
        db.delete_index('community_photo', ['created'])

        # Removing index on 'Post', fields ['created']
        db.delete_index('community_post', ['created'])

        # Removing index on 'Link', fields ['created']
        db.delete_index('community_link', ['created'])

        # Removing index on 'Video', fields ['created']
        db.delete_index('community_video', ['created'])
    ...
    models = {
        ...
        'community.link': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'null': 'True', 'related_name': "'community_link_creator'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'null': 'True', 'related_name': "'community_link_modified'", 'blank': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['community.Post']", 'null': 'True', 'related_name': "'related_link'"}),
        ...
        'community.photo': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'default': 'datetime.datetime.now', 'db_index': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'null': 'True', 'related_name': "'community_photo_creator'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'null': 'True', 'related_name': "'community_photo_modified'", 'blank': 'True'}),
        ...
        'community.post': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'default': 'datetime.datetime.now', 'db_index': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'null': 'True', 'related_name': "'community_post_creator'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'null': 'True', 'related_name': "'community_post_modified'", 'blank': 'True'}),
            ...
            'title': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '200'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'})
        },
        'community.video': {
            ...
            'click_through_url': ('django.db.models.fields.URLField', [], {'blank': 'True', 'max_length': '200'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'default': 'datetime.datetime.now', 'db_index': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'null': 'True', 'related_name': "'community_video_creator'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'null': 'True', 'related_name': "'community_video_modified'", 'blank': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['community.Post']", 'null': 'True', 'related_name': "'related_video'"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
