    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "version",
                    models.IntegerField(
                        choices=[(3, "Python 3.x.x"), (2, "Python 2.x.x"), (1, "Python 1.x.x")], default=2
                    ),
                ),
                (
                    "is_latest",
                ...
                (
                    "release_page",
                    models.ForeignKey(
                        null=True, to="pages.Page", related_name="release", blank=True, on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gpg_signature_file",
                    models.URLField(help_text="GPG Signature URL", verbose_name="GPG SIG URL", blank=True),
                ),
                ("md5_sum", models.CharField(max_length=200, verbose_name="MD5 Sum", blank=True)),
                ("filesize", models.IntegerField(default=0)),
                (
                    "download_button",
                    models.BooleanField(help_text="Use for the supernav download button for this OS", default=False),
                ),
                (
                    "creator",
                    models.ForeignKey(
                ...
                (
                    "os",
                    models.ForeignKey(
                        verbose_name="OS", to="downloads.OS", related_name="releases", on_delete=models.CASCADE
                    ),
                ),
