    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(null=True, to=settings.AUTH_USER_MODEL, related_name='downloads_os_creator', blank=True)),
                ('last_modified_by', models.ForeignKey(null=True, to=settings.AUTH_USER_MODEL, related_name='downloads_os_modified', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(null=True, to=settings.AUTH_USER_MODEL, related_name='downloads_release_creator', blank=True)),
                ('last_modified_by', models.ForeignKey(null=True, to=settings.AUTH_USER_MODEL, related_name='downloads_release_modified', blank=True)),
                ('release_page', models.ForeignKey(null=True, to='pages.Page', related_name='release', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(null=True, to=settings.AUTH_USER_MODEL, related_name='downloads_releasefile_creator', blank=True)),
                ('last_modified_by', models.ForeignKey(null=True, to=settings.AUTH_USER_MODEL, related_name='downloads_releasefile_modified', blank=True)),
                ('os', models.ForeignKey(verbose_name='OS', to='downloads.OS', related_name='releases')),
                ('release', models.ForeignKey(to='downloads.Release', related_name='files')),
            ],
            options={
