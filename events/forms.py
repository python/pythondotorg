...
class EventForm(forms.Form):
    ...
    event_type = forms.CharField(widget=set_placeholder("conference, bar camp, sprint, user group meeting, etc."))
    python_focus = forms.CharField(
        widget=set_placeholder("Data analytics, Web Development, Country-wide conference, etc...")
    )
    ...
    recurrence = forms.CharField(widget=set_placeholder("None, every second Thursday, monthly, etc."))
