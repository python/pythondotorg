...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Calendar.url'
        db.add_column('events_calendar', 'url',
                      self.gf('django.db.models.fields.URLField')(blank=True, max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Calendar.url'
        db.delete_column('events_calendar', 'url')
    ...
    models = {
        ...
        'events.event': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['events.EventCategory']", 'blank': 'True', 'symmetrical': 'False', 'related_name': "'events'", 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'default': 'datetime.datetime.now', 'db_index': 'True'}),
