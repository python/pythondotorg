...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OccurringRule.all_day'
        db.add_column('events_occurringrule', 'all_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RecurringRule.all_day'
        db.add_column('events_recurringrule', 'all_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OccurringRule.all_day'
        db.delete_column('events_occurringrule', 'all_day')

        # Deleting field 'RecurringRule.all_day'
        db.delete_column('events_recurringrule', 'all_day')
    ...
    models = {
        ...
        'events.alarm': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'blank': 'True', 'related_name': "'events_alarm_creator'", 'null': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['events.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'blank': 'True', 'related_name': "'events_alarm_modified'", 'null': 'True'}),
        ...
        'events.calendar': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'blank': 'True', 'default': 'datetime.datetime.now'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'blank': 'True', 'related_name': "'events_calendar_creator'", 'null': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'blank': 'True', 'related_name': "'events_calendar_modified'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'events.event': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'events'", 'blank': 'True', 'symmetrical': 'False', 'null': 'True', 'to': "orm['events.EventCategory']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'blank': 'True', 'default': 'datetime.datetime.now'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'blank': 'True', 'related_name': "'events_event_creator'", 'null': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'blank': 'True', 'related_name': "'events_event_modified'", 'null': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'uid': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '200', 'null': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'venue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['events.EventLocation']", 'blank': 'True', 'related_name': "'events'", 'null': 'True'})
        },
        'events.eventcategory': {
            'Meta': {'ordering': "('name',)", 'object_name': 'EventCategory'},
            'calendar': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['events.Calendar']", 'blank': 'True', 'related_name': "'categories'", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'events.eventlocation': {
            ...
            'calendar': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['events.Calendar']", 'blank': 'True', 'related_name': "'locations'", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
