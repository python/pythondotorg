output "testing-the_ngwaf" {
  ...
  https://cfg.fastly.com/${fastly_service_vcl.ngwaf_service.id}
  ...
  curl https://api.fastly.com/service/${fastly_service_vcl.ngwaf_service.id}/logging_status -H fastly-key:$FASTLY_API_KEY
  tfmultiline
