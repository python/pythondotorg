...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.description_markup_type'
        db.add_column('jobs_job', 'description_markup_type',
                      self.gf('django.db.models.fields.CharField')(max_length=30, default='restructuredtext', blank=True),
                      keep_default=False)

        # Adding field 'Job._description_rendered'
        db.add_column('jobs_job', '_description_rendered',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'Job.description'
        db.alter_column('jobs_job', 'description', self.gf('markupfield.fields.MarkupField')(rendered_field=True))

    def backwards(self, orm):
        # Deleting field 'Job.description_markup_type'
        db.delete_column('jobs_job', 'description_markup_type')

        # Deleting field 'Job._description_rendered'
        db.delete_column('jobs_job', '_description_rendered')


        # Changing field 'Job.description'
        db.alter_column('jobs_job', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'jobs.job': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['auth.User']"}),
