...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.last_modified_by'
        db.add_column('jobs_job', 'last_modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['users.User'], related_name='jobs_job_modified'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.last_modified_by'
        db.delete_column('jobs_job', 'last_modified_by_id')
    ...
    models = {
        ...
        'jobs.job': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['users.User']", 'related_name': "'jobs_job_creator'"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job_types': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'to': "orm['jobs.JobType']", 'related_name': "'jobs'"}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['users.User']", 'related_name': "'jobs_job_modified'"}),
