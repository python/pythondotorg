...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Job.company'
        db.alter_column('jobs_job', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['companies.Company']))
    ...
    models = {
        ...
        'jobs.job': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'jobs'", 'null': 'True', 'blank': 'True', 'to': "orm['companies.Company']"}),
            'contact': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '100', 'blank': 'True'}),
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'jobs_job_creator'", 'null': 'True', 'blank': 'True', 'to': "orm['users.User']"}),
            ...
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'jobs_job_modified'", 'null': 'True', 'blank': 'True', 'to': "orm['users.User']"}),
