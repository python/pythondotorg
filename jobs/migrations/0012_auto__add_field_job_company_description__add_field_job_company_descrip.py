...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('jobs_job', 'company_description',
                      self.gf('markupfield.fields.MarkupField')(blank=True, rendered_field=True, null=True),
                      keep_default=False)

        # Adding field 'Job.company_description_markup_type'
        db.add_column('jobs_job', 'company_description_markup_type',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=30, default='restructuredtext'),
                      keep_default=False)
    ...
    models = {
        ...
        'jobs.job': {
            ...
            'company_description': ('markupfield.fields.MarkupField', [], {'blank': 'True', 'rendered_field': 'True', 'null': 'True'}),
