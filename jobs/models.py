...
from .signals import job_was_submitted, job_was_approved, job_was_rejected, comment_was_posted
...
class Job(ContentManageable):
    ...
    contact = models.CharField(verbose_name="Contact name", null=True, blank=True, max_length=100)
