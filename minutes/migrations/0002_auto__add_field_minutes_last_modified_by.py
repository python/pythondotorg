...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Minutes.last_modified_by'
        db.add_column('minutes_minutes', 'last_modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='minutes_minutes_modified', to=orm['users.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Minutes.last_modified_by'
        db.delete_column('minutes_minutes', 'last_modified_by_id')
    ...
    models = {
        ...
        'minutes.minutes': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'minutes_minutes_creator'", 'to': "orm['users.User']", 'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'minutes_minutes_modified'", 'to': "orm['users.User']", 'null': 'True', 'blank': 'True'}),
