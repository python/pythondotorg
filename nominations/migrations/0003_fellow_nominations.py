    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nominations_cutoff",
                    models.DateField(help_text="20th of month 2 per WG Charter (Feb 20, May 20, Aug 20, Nov 20)."),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, help_text="Snapshot: was the nominee already a Fellow at submission time?"
                    ),
                ),
                (
                    "creator",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="nominations.fellownominationround",
                    ),
                ),
                (
                    "last_modified_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "vote",
                    models.CharField(choices=[("yes", "Yes"), ("no", "No"), ("abstain", "Abstain")], max_length=10),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="votes",
                        to="nominations.fellownomination",
                    ),
                ),
                (
                    "voter",
