...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.content_markup_type'
        db.add_column('pages_page', 'content_markup_type',
                      self.gf('django.db.models.fields.CharField')(max_length=30, default='restructuredtext'),
                      keep_default=False)

        # Adding field 'Page._content_rendered'
        db.add_column('pages_page', '_content_rendered',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'Page.content'
        db.alter_column('pages_page', 'content', self.gf('markupfield.fields.MarkupField')(rendered_field=True))

    def backwards(self, orm):
        # Deleting field 'Page.content_markup_type'
        db.delete_column('pages_page', 'content_markup_type')

        # Deleting field 'Page._content_rendered'
        db.delete_column('pages_page', '_content_rendered')


        # Changing field 'Page.content'
        db.alter_column('pages_page', 'content', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'pages.page': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'path': ('django.db.models.fields.CharField', [], {'max_length': '500', 'unique': 'True'}),
