...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pages_page', 'keywords',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=1000),
                      keep_default=False)
    ...
    models = {
        ...
        'pages.page': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'related_name': "'pages_page_creator'", 'to': "orm['users.User']"}),
            ...
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'related_name': "'pages_page_modified'", 'to': "orm['users.User']"}),
