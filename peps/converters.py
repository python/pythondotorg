...
def get_peps_last_updated():
    ...
    if last_update is None:
        return datetime.datetime(1970, 1, 1, tzinfo=datetime.timezone(datetime.timedelta(0)))
    return last_update
...
def get_pep_page(artifact_path, pep_number, commit=True):
    ...
    source_link = "https://github.com/python/peps/blob/master/pep-{}{}".format(pep_number, pep_ext)
