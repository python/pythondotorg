...
from peps.converters import get_pep0_page, get_pep_page, add_pep_image, get_peps_rss, get_peps_last_updated
        ...
        with ExitStack() as stack:
            ...
            for f in os.listdir(artifacts_path):
                ...
                if pep_match:
                    ...
                    if p is None:
                        verbose("- HTML version PEP {!r} cannot be generated.".format(pep_number))
            ...
            for img in image_paths:
                ...
                if pep_match:
                    pep_number = pep_match.groups(1)[0]
                    verbose("Generating image for PEP {} at '{}'".format(pep_number, img))
