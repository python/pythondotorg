...
class TemplateProcessorsTestCase(TestCase):
    ...
    def test_url_name(self):
        ...
        self.assertEqual(
            {"URL_NAMESPACE": "events", "URL_NAME": "events:calendar_list"}, context_processors.url_name(request)
        )
    ...
    def test_user_nav_bar_links_for_non_psf_members(self):
        ...
        self.assertEqual({"USER_NAV_BAR": expected_nav}, context_processors.user_nav_bar_links(request))
    ...
    def test_user_nav_bar_sponsorship_links(self):
        ...
        expected_section = {"label": "Sponsorships Dashboard", "url": reverse("users:user_sponsorships_dashboard")}

        self.assertEqual(
            expected_section, context_processors.user_nav_bar_links(request)["USER_NAV_BAR"]["sponsorships"]
        )
