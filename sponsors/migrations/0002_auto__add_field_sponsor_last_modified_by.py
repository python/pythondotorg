...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sponsor.last_modified_by'
        db.add_column('sponsors_sponsor', 'last_modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.User'], blank=True, related_name='sponsors_sponsor_modified'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sponsor.last_modified_by'
        db.delete_column('sponsors_sponsor', 'last_modified_by_id')
    ...
    models = {
        ...
        'sponsors.sponsor': {
            ...
            'content_markup_type': ('django.db.models.fields.CharField', [], {'max_length': '30', 'default': "'restructuredtext'", 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['users.User']", 'blank': 'True', 'related_name': "'sponsors_sponsor_creator'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['users.User']", 'blank': 'True', 'related_name': "'sponsors_sponsor_modified'"}),
