...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Sponsor', fields ['created']
        db.create_index('sponsors_sponsor', ['created'])

        # Adding index on 'Sponsor', fields ['is_published']
        db.create_index('sponsors_sponsor', ['is_published'])


    def backwards(self, orm):
        # Removing index on 'Sponsor', fields ['is_published']
        db.delete_index('sponsors_sponsor', ['is_published'])

        # Removing index on 'Sponsor', fields ['created']
        db.delete_index('sponsors_sponsor', ['created'])
    ...
    models = {
        ...
        'sponsors.sponsor': {
            ...
            'content': ('markupfield.fields.MarkupField', [], {'blank': 'True', 'rendered_field': 'True'}),
            'content_markup_type': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '30', 'default': "'restructuredtext'"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'blank': 'True', 'default': 'datetime.datetime.now'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['users.User']", 'related_name': "'sponsors_sponsor_creator'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'db_index': 'True', 'default': 'False'}),
            'last_modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['users.User']", 'related_name': "'sponsors_sponsor_modified'"}),
