...
class SelectSponsorshipApplicationBenefitsViewTests(TestCase):
    ...
    def setUp(self):
        ...
        package_2 = baker.make("sponsors.SponsorshipPackage", advertisable=True)
    ...
    def test_display_template_with_form_and_context(self):
        psf_package = baker.make("sponsors.SponsorshipPackage", advertisable=True)
        extra_package = baker.make("sponsors.SponsorshipPackage", advertisable=True)
