    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            (1, "Allow search engines to index my profile page (recommended)"),
                            (0, "Don't allow search engines to index my profile page"),
                        ],
                        default=1,
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            ...
                            (1, "Only logged-in users can see my e-mail address"),
                            (2, "No one can ever see my e-mail address"),
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "psf_announcements",
                    models.NullBooleanField(verbose_name="I would like to receive occasional PSF email announcements"),
                ),
