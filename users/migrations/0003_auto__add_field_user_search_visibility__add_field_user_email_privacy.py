...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.search_visibility'
        db.add_column('users_user', 'search_visibility',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'User.email_privacy'
        db.add_column('users_user', 'email_privacy',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.search_visibility'
        db.delete_column('users_user', 'search_visibility')

        # Deleting field 'User.email_privacy'
        db.delete_column('users_user', 'email_privacy')
    ...
    models = {
        ...
        'users.user': {
            ...
            'email_privacy': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            ...
            'search_visibility': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
