    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, related_name='work_groups_workgroup_creator', to=settings.AUTH_USER_MODEL, null=True)),
                ('last_modified_by', models.ForeignKey(blank=True, related_name='work_groups_workgroup_modified', to=settings.AUTH_USER_MODEL, null=True)),
